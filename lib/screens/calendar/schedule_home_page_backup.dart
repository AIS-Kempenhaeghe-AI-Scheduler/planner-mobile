  ...
  void _loadEventsForCurrentView() {
    ...
    switch (_currentView) {
      case ViewType.week:
        ...
        scheduleService.getAllEmployeesWeeklySchedule(startDateStr);
        break;
      case ViewType.month:
        scheduleService.getAllEmployeesMonthlySchedule(
            _focusedDay.year, _focusedDay.month);
        break;
      case ViewType.day:
        final dateStr = scheduleService.formatDate(_focusedDay);
        scheduleService.getAllEmployeesDailySchedule(dateStr);
        break;
    }
  }
